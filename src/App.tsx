...
function App() {
  ...
  const [presupuesto, setPresupuesto] = useState<number>( localStorage.getItem('presupuesto') ? parseInt(localStorage.getItem('presupuesto') as string) : 0 );
  ...
  const [gastosFiltrados, setGastosFiltrados] = useState<GastoType[]>([]);
